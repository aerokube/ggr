...
func TestEmptyListOfHosts(t *testing.T) {
	...
	AssertThat(t, host, Is{V: (*Host)(nil)})
	AssertThat(t, index, EqualTo{V: -1})
}
...
func TestChooseFirst(t *testing.T) {
	...
	AssertThat(t, host.Name, EqualTo{V: "first"})
	AssertThat(t, index, EqualTo{V: 0})
}
...
func TestChooseMid(t *testing.T) {
	...
	AssertThat(t, host.Name, EqualTo{V: "mid"})
	AssertThat(t, index, EqualTo{V: 1})
}
...
func TestChooseLast(t *testing.T) {
	...
	AssertThat(t, host.Name, EqualTo{V: "last"})
	AssertThat(t, index, EqualTo{V: 2})
}
...
func TestFindDefaultVersion(t *testing.T) {
	...
	AssertThat(t, version, EqualTo{V: "2.0"})
	AssertThat(t, len(hosts), EqualTo{V: 1})
	AssertThat(t, hosts[0].Name, EqualTo{V: "browser-2.0"})
}

func TestFindVersion(t *testing.T) {
	hosts, version, _ := browsersWithMultipleVersions.find("browser", "1.0", "LINUX", newSet(), newSet())
	AssertThat(t, version, EqualTo{V: "1.0"})
	AssertThat(t, len(hosts), EqualTo{V: 1})
	AssertThat(t, hosts[0].Name, EqualTo{V: "browser-1.0"})
}
...
func TestVersionNotFound(t *testing.T) {
	...
	AssertThat(t, version, EqualTo{V: "missing"})
	AssertThat(t, len(hosts), EqualTo{V: 0})
}
...
func TestFindWithExcludedRegions(t *testing.T) {
	...
	AssertThat(t, version, EqualTo{V: "1.0"})
	AssertThat(t, len(hosts), EqualTo{V: 1})
	AssertThat(t, hosts[0].Name, EqualTo{V: "browser-e-1.0"})
}
...
func TestFindWithExcludedRegionsExhausted(t *testing.T) {
	...
	AssertThat(t, len(hosts), EqualTo{V: 2})
	AssertThat(t, excludedRegions.size(), EqualTo{V: 0})
}
...
func TestFindWithExcludedHosts(t *testing.T) {
	...
	AssertThat(t, version, EqualTo{V: "1.0"})
	AssertThat(t, len(hosts), EqualTo{V: 1})
	AssertThat(t, hosts[0].Name, EqualTo{V: "browser-f-1.0"})
}
...
func TestFindWithDefaultPlatform(t *testing.T) {
	...
	AssertThat(t, version, EqualTo{V: "2.0"})
	AssertThat(t, len(hosts), EqualTo{V: 1})
	AssertThat(t, hosts[0].Name, EqualTo{V: "browser-2.0-linux"})
}
...
func TestFindWithPlatformPrefix(t *testing.T) {
	...
	AssertThat(t, version, EqualTo{V: "2.0"})
	AssertThat(t, len(hosts), EqualTo{V: 1})
	AssertThat(t, hosts[0].Name, EqualTo{V: "browser-2.0-windows"})
}
...
func TestReadNotExistingConfig(t *testing.T) {
	...
	AssertThat(t, err, Is{V: Not{}})
	AssertThat(t, err.Error(), EqualTo{V: fmt.Sprintf("error reading configuration file %s: open %s: no such file or directory", tmp.Name(), tmp.Name())})
}
...
func TestParseInvalidConfig(t *testing.T) {
	...
	AssertThat(t, err, Is{V: Not{}})
	AssertThat(t, err.Error(), EqualTo{V: fmt.Sprintf("error parsing configuration file %s: EOF", tmp.Name())})
}
...
func TestParseConfig(t *testing.T) {
	...
	AssertThat(t, err, Is{})
	AssertThat(t, browsers.Browsers[0].Name, EqualTo{V: "browser"})
}
...
func TestChoosingAllHosts(t *testing.T) {
	...
	AssertThat(t, chosenHosts["first"] > 0, Is{V: true})
	AssertThat(t, chosenHosts["mid"] > 0, Is{V: true})
	AssertThat(t, chosenHosts["last"] > 0, Is{V: true})
}
